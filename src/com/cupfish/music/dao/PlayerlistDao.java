...
import com.cupfish.music.utils.PlayerListDbHelper;
		...
		try {
			...
			if (db.isOpen()) {
				...
				for (Song song : playlist) {
					Object[] params = { song.getSongId(), song.getTitle(), song.getAlbum(), song.getAlbum().getId(), song.getArtist(), song.getSongUrl(), song.getDuration(),
							1 };

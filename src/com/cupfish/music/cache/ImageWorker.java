...
import com.cupfish.music.BuildConfig;
...
public abstract class ImageWorker {
    ...
    private NewImageCache mImageCache;
    private NewImageCache.ImageCacheParams mImageCacheParams;
    ...
    public void addImageCache(FragmentManager fragmentManager,
    		NewImageCache.ImageCacheParams cacheParams) {
        mImageCacheParams = cacheParams;
        setImageCache(NewImageCache.findOrCreateCache(fragmentManager, mImageCacheParams));
     ...
     * @param imageCache
     */
    public void setImageCache(NewImageCache imageCache) {
    ...
    public static void cancelWork(ImageView imageView) {
        ...
        if (bitmapWorkerTask != null) {
            ...
            if (BuildConfig.DEBUG) {
                Log.d(TAG, "cancelWork - cancelled work  " );
            }
        }
    }
    ...
    public static boolean cancelPotentialWork(Object data, ImageView imageView) {
        ...
        if (bitmapWorkerTask != null && bitmapWorkerTask.info != null) {
            final Object bitmapData = bitmapWorkerTask.info.encode();
    ...
    private class BitmapWorkerTask extends AsyncTask<Object, Void, Bitmap> {
        ...
        protected Bitmap doInBackground(Object... params) {
            ...
            info = (ImageInfo) params[0];
            final String dataString = info.encode();
            Bitmap bitmap = null;
			...
			if (bitmap == null && !isCancelled() && getAttachedImageView() != null && !mExitTasksEarly) {
				// TODO 验证从MediaStore中获取封面
				bitmap = ImageUtils.getImageFromMediaStore(context, info);
			}
